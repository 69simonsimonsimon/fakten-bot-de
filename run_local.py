#!/usr/bin/env python3
"""
SynCin Fakten-Bot DE — Lokaler Video-Generator
================================================
Generiert ein Fakten-Video und lädt es in die Bunny-Queue.
GitHub Actions postet es automatisch nach Schedule.

Usage:
  python run_local.py              # zufälliges Thema
  python run_local.py science
  python run_local.py space 3      # 3 Videos generieren
"""
...
logger = logging.getLogger("faktbot")
...
def generate_and_queue(topic: str = None) -> bool:
    ...
    # 1. Fakt generieren
    logger.info(f"💡  Generiere Fakt — Thema: {topic}")
    ...
    filename = f"fakten_de_{stamp}.mp4"
    ...
    logger.info(f"    Titel: {fact_data['title']}")
    return True
